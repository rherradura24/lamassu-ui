    ...
    components: {
        ...
        MuiDataGrid: {
            styleOverrides: {
                root: {
                    ...
                    "& .MuiDataGrid-row": {
                        alignItems: "center",
                        borderBottom: `1px solid ${colors.alpha.black[10]}`
                    },
                    "& .MuiDataGrid-cell": {
                        border: "0px"
                    },
        ...
        MuiTabs: {
            styleOverrides: {
                ...
                indicator: {
                    ...
                    background: lighten(colors.primary.main, 0.7),
                    color: colors.primary.main
                },
                scrollableX: {
        ...
        MuiStepIcon: {
            styleOverrides: {
                root: {
                    "&.Mui-completed": {
                        color: lighten(colors.primary.main, 0.7),
                        background: colors.primary.main
                    },
                    "&.Mui-active": {
                        background: colors.primary.main
