                    ...
                    <Box component={Paper} style={{marginTop: 20, padding: 20, display: "flex", justifyContent: "space-between"}}>
                        <Box>
                            ...
                            <Box style={{display: "flex", marginBottom: 5}}>
                                ...
                                <LamassuChip status={"green"} rounded={false} label={"Provisioned"}/>
                            </Box>
                            <Box style={{display: "flex", marginBottom: 5}}>
                            ...
                            <Box style={{display: "flex", marginBottom: 5}}>
                                ...
                                <LamassuChip status={"orange"} rounded={false}  label={"Medium"}/>
                            </Box>
                        </Box>
                        <Box style={{display: "flex", flexDirection: "column", justifyContent: "center"}}>
                            <Button variant="contained" color="primary">Revoke current certificate</Button>
                            <Button variant="contained" color="primary" style={{marginTop: 10}}>Recreate Private Key</Button>
                            <Button variant="contained" color="primary" style={{marginTop: 10}}>Delete Device</Button>
                        </Box>
                    </Box>
                                            ...
                                            <TimelineItem>
                                                <TimelineOppositeContent style={{maxWidth: 200}}>
                                                    <Typography variant="body2" color="textSecondary">
                                                        {moment(log.ts).format("MMMM D YYYY, HH:mm:ss Z").toString()}
                                                    </Typography>
                                                </TimelineOppositeContent>
                                                <TimelineSeparator>
                                                {
                                                    log.type == "PRIV_KEY_REGENERATION" && (
                                                        <>  
                                                            <TimelineDot style={{background: red.bg}}>
                                                                <RepeatIcon style={{ color: red.txt}}/>
                                                            </TimelineDot>
                                                ...
                                                <TimelineContent>
                                                    <Paper elevation={3} style={{padding: 10}}>
                                                        <Typography variant="button" component="h1" color="primary">{log.msg_title}</Typography>
                                                        <Typography>{log.msg_content}</Typography>
                                                    </Paper>
                                                </TimelineContent>
                                            </TimelineItem>
                                        ))
