...
const EnabledConnectorSynchronization = ({caName,caCert,  connector, isOpen, onClose=()=>{}, onSync={}}) => {
        ...
        isOpen ? (
            <Dialog open={isOpen} onClose={()=>onClose()} style={{backgroundColor: 'transparent'}}>
                ...
                <DialogActions>
                    ...
                    <Button onClick={()=>{onSync(connector.id, caName, caCert); onClose()}} variant="contained">Synchronize</Button>
...
const mapDispatchToProps = (dispatch, {}) => ({
   ...
   onSync: (connectorId, caName, caCert)=>{dispatch(cloudProxyDuck.actions.forceSynchronizeCloudConnector(connectorId, caName, caCert))}
})
